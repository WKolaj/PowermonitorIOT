...
const S7FloatVariable = require("../../../classes/variable/S7/S7FloatVariable");
...
describe("S7FloatVariable", () => {
  ...
  describe("init", () => {
    ...
    let exec = async () => {
      ...
      variable = new S7FloatVariable(device);
  ...
  describe("_convertDataToValue", () => {
    ...
    it("should return proper value - if value is greater than 0", async () => {
      let result = await exec();

      expect(result).toBeCloseTo(123.321);
    });

    it("should return proper value - if value is smaller than 0", async () => {
      data = [194, 246, 164, 90];
  ...
  describe("_convertValueToData", () => {
    ...
    it("should return proper data - if value is greater than 0", async () => {
      ...
      expect(result).toEqual([66, 246, 164, 90]);
    });
    ...
    it("should return proper data - if value is smaller than 0", async () => {
      ...
      expect(result).toEqual([194, 246, 164, 90]);
    });
