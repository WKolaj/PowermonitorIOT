...
const S7UInt16Variable = require("../../../classes/variable/S7/S7UInt16Variable");
...
describe("S7UInt16Variable", () => {
  ...
  describe("init", () => {
    ...
    let exec = async () => {
      ...
      variable = new S7UInt16Variable(device);
    ...
    it("should set length to 2 if it is not defined in payload", async () => {
    ...
    it("should set length to 2 even if it is defined in payload as a different value", async () => {
