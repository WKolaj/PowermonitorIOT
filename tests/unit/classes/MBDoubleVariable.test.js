const MBDoubleVariable = require("../../../classes/variable/Modbus/MBDoubleVariable");

describe("MBDoubleVariable", () => {
  describe("constructor", () => {
    ...
    let exec = () => {
      return new MBDoubleVariable(device);
    };

    it("should throw if device is empty", () => {
      expect(() => new MBDoubleVariable()).toThrow();
    });
  ...
  describe("init", () => {
    ...
    let exec = async () => {
      ...
      variable = new MBDoubleVariable(device, payload);
  ...
  describe("_getPossibeFCodes", () => {
    ...
    let exec = async () => {
      ...
      mbVariable = new MBDoubleVariable(device);
  ...
  describe("editWithPayload", () => {
    ...
    let exec = async () => {
      ...
      variable = new MBDoubleVariable(device);
