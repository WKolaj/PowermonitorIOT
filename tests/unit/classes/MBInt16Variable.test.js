...
describe("MBInt16Variable", () => {
  describe("constructor", () => {
    ...
    let exec = () => {
      return new MBInt16Variable(device);
    };

    it("should throw if device is empty", () => {
      expect(() => new MBInt16Variable()).toThrow();
    });
  ...
  describe("init", () => {
    ...
    let exec = async () => {
      ...
      variable = new MBInt16Variable(device, payload);
    ...
    it("should set Type to corresponding type", async () => {
      ...
      expect(variable.Type).toEqual("mbInt16");
    });
  });
  ...
  describe("_getPossibeFCodes", () => {
    ...
    let exec = async () => {
      ...
      mbVariable = new MBInt16Variable(device);
  ...
  describe("editWithPayload", () => {
    ...
    it("should edit identical variable with payload with appropriate parameters if no parameters are passed in payload", async () => {
