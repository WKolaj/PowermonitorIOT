const MBSwappedDoubleVariable = require("../../../classes/variable/Modbus/MBSwappedDoubleVariable");

describe("MBSwappedDoubleVariable", () => {
  describe("constructor", () => {
    ...
    let exec = () => {
      return new MBSwappedDoubleVariable(device);
    };

    it("should throw if device is empty", () => {
      expect(() => new MBSwappedDoubleVariable()).toThrow();
    });

    it("should create new MBDoubleVariable and assign its device", () => {
      let result = exec();
  ...
  describe("init", () => {
    ...
    let exec = async () => {
      ...
      variable = new MBSwappedDoubleVariable(device, payload);
    ...
    it("should set length to 4", async () => {
      await exec();
    ...
    it("should set Type to corresponding type", async () => {
      ...
      expect(variable.Type).toEqual("mbSwappedDouble");
    });
  });
  ...
  describe("_getPossibeFCodes", () => {
    ...
    let exec = async () => {
      ...
      mbVariable = new MBSwappedDoubleVariable(device);
  ...
  describe("editWithPayload", () => {
    ...
    let exec = async () => {
      ...
      variable = new MBSwappedDoubleVariable(device);
    ...
    it("should alwyas set Length to 4 - despite value in payload", async () => {
      editLength = 1234;
