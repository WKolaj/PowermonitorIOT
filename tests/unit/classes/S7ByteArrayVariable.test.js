...
const S7ByteArrayVariable = require("../../../classes/variable/S7/S7ByteArrayVariable");
...
describe("S7ByteArrayVariable", () => {
  ...
  describe("init", () => {
    ...
    let exec = async () => {
      ...
      variable = new S7ByteArrayVariable(device);
    ...
    it("should set value of variable if it is given in payload", async () => {
      variablePayload.value = [1, 2];
      await exec();

      expect(variable.Value).toEqual([1, 2]);
    });

    it("should set value of variable to [0,0,0...] if it is not defined in payload", async () => {
      variablePayload.value = undefined;

      await exec();

      expect(variable.Value).toEqual([0, 0]);
    });
    ...
    it("should throw if length is not defined", async () => {
  ...
  describe("editWithPayload", () => {
    ...
    it("should set archive to false event if it is given as true", async () => {
  ...
  describe("ValueType", () => {
    ...
    it("should return byteArray", async () => {
      let result = await exec();
  ...
  describe("_convertDataToValue", () => {
    ...
    it("should return the same value as data is", async () => {
      let result = await exec();
  ...
  describe("_convertValueToData", () => {
    ...
    let exec = async () => {
      ...
      return variable._convertValueToData(data);
    };

    it("should return the same value as value is", async () => {
      let result = await exec();

      expect(result).toEqual(data);
    });

    it("should empty array if value is empty", async () => {
      data = [];
