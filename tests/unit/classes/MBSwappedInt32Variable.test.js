...
describe("MBSwappedInt32Variable", () => {
  describe("constructor", () => {
    ...
    let exec = () => {
      return new MBSwappedInt32Variable(device);
    };

    it("should throw if device is empty", () => {
      expect(() => new MBSwappedInt32Variable()).toThrow();
    });
  ...
  describe("init", () => {
    ...
    it("should set Type to corresponding type", async () => {
      ...
      expect(variable.Type).toEqual("swappedInt32");
    });
  });
  ...
  describe("_getPossibeFCodes", () => {
    ...
    let exec = async () => {
      ...
      mbVariable = new MBSwappedInt32Variable(device);
