...
describe("Project", () => {
  ...
  describe("getValue", () => {
    ...
    it("should return actual value of variable of device together with its valueTickId - if element id is variable id", async () => {
      let result = await exec();
    ...
    it("should return actual value of calcElement of device together with its valueTickId - if element id is calcElement id", async () => {
      elementId = "1002";
      let result = await exec();
