...
const S7UInt8Variable = require("../../../classes/variable/S7/S7UInt8Variable");
...
describe("S7UInt8Variable", () => {
  ...
  describe("init", () => {
    ...
    let exec = async () => {
      ...
      variable = new S7UInt8Variable(device);
    ...
    it("should set length to 1 even if it is defined in payload as a different value", async () => {
