...
describe("events route", () => {
  ...
  describe("GET /:deviceId/:elementId", () => {
    ...
    let exec = async () => {
      ...
      if (token) {
        return request(server)
          .get(
            `${endpoint}/${deviceId}/${variableId}?timeRangeStart=${startTimeRange}&timeRangeStop=${stopTimeRange}`
          )
    ...
    it("should return code 200 and valid payload of event for given timesRange", async () => {
      ...
      let expectedPayload = [
        ...
        {
          [mbInt16Variable.Value]: eventLog.Descriptions[mbUInt16Variable.Value]
        }
      ];
    ...
    it("should return code 200 and valid payload of event for given timesRange - if event value is not presented in descriptions", async () => {
    ...
    it("should return code 200 and valid payload of event for given timeRange - if there is no events", async () => {
    ...
    it("should return code 200 and valid payload of event for given timeRange - if there is no event for given timeRanges", async () => {
      startTimeRange = 5;
      stopTimeRange = 10;
    ...
    it("should return code 200 and valid payload of event for given timeRange - startTimeRange is greater than stopTimeRange", async () => {
      startTimeRange = 12347;
      stopimeRange = 12346;
