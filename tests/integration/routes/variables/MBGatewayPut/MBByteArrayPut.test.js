  ...
  describe("UPDATE /:deviceId/:variableId", () => {
    ...
    it("should edit variable based on payload and return code 200", async () => {
      ...
      let variablePayload = {
        ...
        unitId: variableBodyEdit.unitId
      };
    ...
    it("should edit variable based on payload and return code 200 - if unit id is not defined", async () => {
      ...
      expect(variablePayload).toEqual({
        ...variableBodyEdit,
        unitId: variableBodyCreate.unitId
      });
    });
    ...
    it("should return code 200 and edit unitId if only unitId is defined", async () => {
    ...
    it("should return code 400 and do not edit variable if unitId is smaller than 1", async () => {
    ...
    it("should return code 400 and do not edit variable if unitId is greater than 255", async () => {
